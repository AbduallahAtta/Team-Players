...
class Player {
    ...
    @Expose
    var strOutfitter: Any? = null
    @SerializedName("strKit")
    @Expose
    var strKit: Any? = null
    @SerializedName("strAgent")
    @Expose
    var strAgent: Any? = null
    ...
    @Expose
    var strCutout: Any? = null
    @SerializedName("strRender")
    @Expose
    var strRender: Any? = null
    @SerializedName("strBanner")
    @Expose
    var strBanner: Any? = null
    @SerializedName("strFanart1")
    @Expose
    var strFanart1: Any? = null
    ...
    @Expose
    var strCreativeCommons: Any? = null
